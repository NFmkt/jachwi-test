...
const results = {
  "집콕 마스터": {
    img: BASE + '01_bangguseok.webp',
    thumb: BASE + '1_bangguseok.png',
    modalImg: BASE + '01_bangguseok.png',
    name: "집콕 마스터",
    sub: '"이불 밖은 위험해!"',
  ...
  "효율 중독자": {
    img: BASE + '02_hyoryul.webp',
    thumb: BASE + '2_hyoryul.png',
    modalImg: BASE + '02_hyoryul.png',
    name: "효율 중독자",
  ...
  "갓성비 장인": {
    img: BASE + '03_gasungbi.webp',
    thumb: BASE + '3_gasungbi.png',
    modalImg: BASE + '03_gasungbi.png',
    name: "갓성비 장인",
  ...
  "인간 아지트": {
    img: BASE + '04_social.webp',
    thumb: BASE + '4_social.png',
    modalImg: BASE + '04_social.png',
    name: "인간 아지트",
    sub: '"집에서도 사람 냄새 나야지!"',
  ...
  "통장 다이어터": {
    img: BASE + '05_jeokja.webp',
    thumb: BASE + '5_jeokja.png',
    modalImg: BASE + '05_jeokja.png',
    name: "통장 다이어터",
    sub: '"통장아.. 이번 달도 버텨보자!"',
  ...
  "멘탈 수호자": {
    img: BASE + '06_mental.webp',
    thumb: BASE + '6_mental.png',
    modalImg: BASE + '06_mental.png',
    name: "멘탈 수호자",
    sub: '"마음의 평화가 제일 중요해!"',
  ...
  "동네 토박이": {
    img: BASE + '07_jibak.webp',
    thumb: BASE + '7_jibak.png',
    modalImg: BASE + '07_jibak.png',
    name: "동네 토박이",
    sub: '"익숙한 게 최고야!"',
  ...
  "플랜 B 보유자": {
    img: BASE + '08_mirae.webp',
    thumb: BASE + '8_mirae.png',
    modalImg: BASE + '08_mirae.png',
    name: "플랜 B 보유자",
    sub: '"일단 계획부터 세워볼게?"',
...
function openTypeModal(key) {
  ...
  modal.innerHTML = `
    <div class="type-modal-box">
      ...
      <img class="modal-img" src="${r.modalImg}" alt="${r.name}" />
      <div class="result-sub">${r.sub}</div>
      <div class="result-desc">${r.desc}</div>
    </div>
  `;
...
function _doSaveImage(r) {
  ...
  document.getElementById('save-img').src = r.modalImg;
